...
import 'package:restaurants_system/features/health_profile/presentation/screens/gender_screen.dart';
...
class WelcomeState extends ConsumerState<Welcome>
    ...
    switchController.addStatusListener((status) async {
      if (status == AnimationStatus.completed) {
        ...
        Navigator.pushReplacement(
          context,
          MaterialPageRoute(
            builder: (_) => hasAccount ? const DashboardScreen() : const GenderScreen(),
          ),
        );
      }
    });
  ...
  void _startSwitchAnimation() {
    if (switchController.status == AnimationStatus.dismissed) {
