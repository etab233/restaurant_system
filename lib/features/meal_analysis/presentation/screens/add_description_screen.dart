...
import 'package:restaurants_system/features/meal_analysis/presentation/screens/food_analysis_screen.dart';

class AddDescriptionScreen extends ConsumerStatefulWidget {
  final String imagePath;
  const AddDescriptionScreen({super.key, required this.imagePath});
  @override
                        ...
                        child: Container(
                          ...
                          child: const Row(
                            ...
                            children: [
                              ...
                              SizedBox(width: 8),
                              Text("Retake Photo", style: TextStyle(color: Colors.white, fontSize: 13)),
                            ],
                          ),
                        ),
                      ),
                        ...
                        child: Column(
                          ...
                          children: [
                            ...
                            Text(
                              ...
                              style: TextStyle(fontSize: 12, height: 1.4, color: Color(0xff617164)),
                            ),
                          ],
                        ),
                      ),
                ...
                Column(
                  ...
                  children: [
                    const Text(
                      ...
                      style: TextStyle(fontSize: 17, fontWeight: FontWeight.w700, color: Color(0xff2D4739)),
                    ),
                    ...
                    TextField(
                      ...
                      decoration: InputDecoration(
                        ...
                        focusedBorder: OutlineInputBorder(
                          borderRadius: BorderRadius.circular(18),
                          borderSide: const BorderSide(color: Color(0xff6BAF92), width: 1.5),
                        ),
                      ),
                    ),
                  ],
