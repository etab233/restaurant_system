// view/calorie_tracker/label_scan.dart
...
class LabelScan extends ConsumerStatefulWidget {
  const LabelScan({super.key});
  @override
  ConsumerState<LabelScan> createState() => _LabelScanState();
}

class _LabelScanState extends ConsumerState<LabelScan>
  ...
  Future<void> _pickFromGallery() async {
    try {
      ...
      await analyzeTabelState.analyze(imagePath: image.path, token: token);
