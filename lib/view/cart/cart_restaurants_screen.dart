...
import 'package:restaurants_system/view/cart/cart_content.dart';
import 'package:restaurants_system/view/cart/empty_cart.dart';
import 'package:restaurants_system/view/cart/locked_screen.dart';
  ...
  void initState() {
    ...
    if (token != null) {
      WidgetsBinding.instance.addPostFrameCallback((_) {
        ref.read(cartProvider.notifier).index(token: token!);
      });
    }
  }
        ...
        child: Padding(
          ...
          child: Skeletonizer(
            ...
            child: RefreshIndicator(
              onRefresh: () async {
                await ref.read(cartProvider.notifier).index(token: token!);
              },
              child: Column(
                children: [
                  Container(
